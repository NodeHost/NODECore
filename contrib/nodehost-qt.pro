...
RESOURCES += src/qt/nodehost.qrc src/qt/nodehost_locale.qrc

TRANSLATIONS += src/qt/locale/nodehost_bg.ts \
                src/qt/locale/nodehost_de.ts \
                src/qt/locale/nodehost_en.ts \
                src/qt/locale/nodehost_es.ts \
                src/qt/locale/nodehost_fi.ts \
                src/qt/locale/nodehost_fr.ts \
                src/qt/locale/nodehost_it.ts \
                src/qt/locale/nodehost_ja.ts \
                src/qt/locale/nodehost_pl.ts \
                src/qt/locale/nodehost_pt.ts \
                src/qt/locale/nodehost_ru.ts \
                src/qt/locale/nodehost_sk.ts \
                src/qt/locale/nodehost_sv.ts \
                src/qt/locale/nodehost_vi.ts \
                src/qt/locale/nodehost_zh_CN.ts \
                src/qt/locale/nodehost_zh_TW.ts
