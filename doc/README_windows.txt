...
Intro
-----
NodeHost (NODE) is a sustainable cryptocurrency modeled after
...
high-powered mining hardware. NodeHost utilizes an energy efficient proof-of-stake algorithm,
can be mined on any computer, and will never require specialized mining equipment.


Setup
-----
Unpack the files into a directory and run nodehost-qt.exe.

NodeHost Core is the original NodeHost client and it builds the backbone of the network.
However, it downloads and stores the entire history of NodeHost transactions;
