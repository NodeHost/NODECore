...
In order to support loading of multiple wallets in nodehost-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is nodehost.cpp.
...
Changes to nodehost.cpp
----------------------
nodehost.cpp is the entry point into nodehost-qt, and as such, will require some minor modifications to provide hooks for
