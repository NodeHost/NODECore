...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/NodeHost/nodehost-detached-sigs.git
...
- Detached signatures will then be committed to the [nodehost-detached-sigs](https://github.com/NodeHost/nodehost-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
