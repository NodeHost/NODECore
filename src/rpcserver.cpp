...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop NodeHost server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "NodeHost server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NodeHost features */
        {"nodehost", "masternode", &masternode, true, true, false},
        {"nodehost", "listmasternodes", &listmasternodes, true, true, false},
        {"nodehost", "getmasternodecount", &getmasternodecount, true, true, false},
        {"nodehost", "masternodeconnect", &masternodeconnect, true, true, false},
        {"nodehost", "masternodecurrent", &masternodecurrent, true, true, false},
        {"nodehost", "masternodedebug", &masternodedebug, true, true, false},
        {"nodehost", "startmasternode", &startmasternode, true, true, false},
        {"nodehost", "createmasternodekey", &createmasternodekey, true, true, false},
        {"nodehost", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"nodehost", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"nodehost", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"nodehost", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"nodehost", "getmasternodescores", &getmasternodescores, true, true, false},
        {"nodehost", "mnbudget", &mnbudget, true, true, false},
        {"nodehost", "preparebudget", &preparebudget, true, true, false},
        {"nodehost", "submitbudget", &submitbudget, true, true, false},
        {"nodehost", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"nodehost", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"nodehost", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"nodehost", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"nodehost", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"nodehost", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"nodehost", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"nodehost", "checkbudgets", &checkbudgets, true, true, false},
        {"nodehost", "mnsync", &mnsync, true, true, false},
        {"nodehost", "spork", &spork, true, true, false},
        {"nodehost", "preparecommunityproposal", &preparecommunityproposal, true, true, false},
        {"nodehost", "submitcommunityproposal", &submitcommunityproposal, true, true, false},
        {"nodehost", "getcommunityinfo", &getcommunityinfo, true, true, false},
        {"nodehost", "checkcommunityproposals", &checkcommunityproposals, true, true, false},
        {"nodehost", "getcommunityproposalvotes", &getcommunityproposalvotes, true, true, false},
        {"nodehost", "mncommunityvote", &mncommunityvote, true, true, false},
...
{
    return "> nodehost-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2154/\n";
}
