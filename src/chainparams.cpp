...
public:
    CMainParams()
    {
        ...
        // NodeHost BIP44 coin type is '420' (0x800001a4)
        // BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x01)(0xa4).convert_to_container<std::vector<unsigned char> >();
