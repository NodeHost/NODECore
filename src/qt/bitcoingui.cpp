                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NodeHost Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NODE address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nodehost: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NodeHost Core"), this);
    aboutAction->setStatusTip(tr("Show information about NodeHost Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for NodeHost"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NODE addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NODE addresses"));
    ...
    openAction->setStatusTip(tr("Open a nodehost: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NodeHost Core help message to get a list with possible NodeHost command-line options"));
...
void BitcoinGUI::createToolBars()
{
    if (walletFrame) {
        /* HEADER */
        QFrame* frameHeader = new QFrame;
        QHBoxLayout* frameHeaderLayout = new QHBoxLayout(frameHeader);
        QLabel* headerLabel = new QLabel;
        frameHeaderLayout->addWidget(headerLabel);
        frameHeader->setStyleSheet(".QFrame{background-color:#6754ff;}.QLabel{background-color:#6754ff;background-image: url(':/images/nodehost_logo_horizontal') no-repeat; background-repeat: no-repeat;background-position: left center; padding:16px;padding-left:0px;margin-left:0px;margin-top:2px;}");
        ...
        frameToolbar->setStyleSheet(".QFrame { max-width: 230px; background-color: #6754ff; }");
        ...
        */
        ...
        centerLayout->addWidget(frameToolbar);
        centerLayout->addWidget(walletFrame);
        centerLayout->setSpacing(0);
        centerLayout->setContentsMargins(QMargins());

        QVBoxLayout* containerlayout = new QVBoxLayout;
        containerlayout->addWidget(frameHeader);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NodeHost Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NodeHost network", "", count));
}
...
{
    QString strTitle = tr("NodeHost Core"); // default title
