...
/** Utility functions used by the NodeHost Qt UI.
 */
namespace GUIUtil
{
...
// Render NODE addresses in monospace font
...
// Parse "nodehost:" URI into recipient object, return true on successful parsing
