...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NodeHost Core nodehost-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nodehost-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded NodeHost transaction") + "\n" +
                               "  nodehost-tx [options] -create [commands]   " + _("Create hex-encoded NodeHost transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded NodeHost transaction
