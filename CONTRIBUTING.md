Contributing to NodeHost Core
==================================

The NodeHost Core project operates an open contributor model where anyone is
...
The following applies to code changes to the NodeHost Core project, and is not to be
confused with overall NodeHost Network Protocol consensus changes.

Whether a pull request is merged into NodeHost Core rests with the project merge
...
Patches that change NodeHost consensus rules are considerably more involved than
...
Where a patch set proposes to change the NodeHost consensus, it must have been
...
The project leader is the release manager for each NodeHost Core release.
