...
#   c) node1 mines 32 blocks, so now node 0 has 500000NODE, node 1 has 4250NODE, node2 has none.
#   d) node0 sends 601 NODE to node2, in two transactions (301 NODE, then 300 NODE).
